...
// import { HeroSection, FilterSection, PageSection, CardGrid } from "@/components/templates";
...
export default function FandomPage() {
  ...
  return (
    <div className="min-h-screen bg-[#875CF5]">
      ...
      <FandomHeader
        fandomName="Nome da Fandom"
        fandomDescription="Descrição da fandom"
        fandomId="123"
        creatorId="456"
      />
      ...
      <main>
          <HeroSection 
            title="Bem-vindo à Fandom"
            description="Descrição da sua fandom incrível"
          ...
          <div>
            ...
            <div className="pl-[150px] pr-[150px]">
              ...
              <div>
                <div className="bg-blue-500 p-[5px] rounded-[10px] w-fit max-w-full mt-[15px] overflow-hidden mb-[15px]">
                  <div className="flex text-[15px] overflow-x-auto gap-[10px]">
                    <button className="pt-[10px] pb-[10px] pl-[20px] pr-[20px] rounded-[10px] transition-all duration-250 whitespace-nowrap bg-red-500 text-white">Todos</button>
                    <button className="pt-[10px] pb-[10px] pl-[20px] pr-[20px] rounded-[10px] transition-all duration-250 whitespace-nowrap bg-red-500 text-white">Categoria 1</button>
                    <button className="pt-[10px] pb-[10px] pl-[20px] pr-[20px] rounded-[10px] transition-all duration-250 whitespace-nowrap bg-red-500 text-white">Categoria 2</button>
                    <button className="pt-[10px] pb-[10px] pl-[20px] pr-[20px] rounded-[10px] transition-all duration-250 whitespace-nowrap bg-red-500 text-white">Categoria 3</button>
                  </div>
                </div>
                <CardGrid className="gap-[20px]">
                  ...
                  <CharacterCard
                    id="6"
                    title="Personagem 6"
                    description="Descrição do personagem 6"
                    color="#926DF6"
                  />
                  <CharacterCard
                    id="6"
              ...
              <div className="flex justify-center">
                <button className="bg-red-500 p-[10px] rounded-[10px] text-white hover:bg-red-600 transition-colors mt-[15px]">Ver mais personagens</button>
              </div>
            </div>
          </div>
      </main>
